    ...
    mixin(
        {
                ...
                cc: {
                    animation: {
                        TCVariableBinding: {
                            ...
                            tooltip:
                                "Use the variable's value as condition value.",
                            properties: {
                                variableName: {
                                    label: "Variable",
                        ...
                        TCAuxiliaryCurveBinding: {
                            ...
                            tooltip:
                                "Use the auxiliary curve 's current value as condition value.",
                            properties: {
                                curveName: {
                                    label: "Curve",
                        ...
                        TCStateWeightBinding: {
                            ...
                            tooltip:
                                "Use the state 's weight as condition value.",
                            abbr: {
                                label: "State Weight",
                                tooltip:
                                    "The current weight of transition source state.",
                            },
                        },
                        TCStateMotionTimeBinding: {
                            menu: "Motion Time Binding",
                            tooltip:
                                "Use the elapsed (normalized) time of motions in state as condition value.",
                            abbr: {
                                label: "Motion Elapsed Time",
                                tooltip:
                                    "The elapsed (normalized) time of motions in transition source state.",
                            },
                        },
                    },
                    CurveRange: {
            ...
            ambient: {
                ...
                groundLightingColor:
                    "Ground Color (Lower sphere lighting source).",
                skyIllum: "Ambient lighting intensity.",
            },
            skybox: {
                EnvironmentLightingType:
                    "Choose environment lighting types: <br>Custom hemisphere diffuse, no reflections. <br>Autogen hemisphere diffuse, with reflections.<br>More accuracy diffuse map, with reflections.",
                enabled:
                    "Enable or disable skybox rendering with Envmap cube texture settings.",
                ...
                rotationAngle:
                    "Adjust Y-axis rotation for skybox and sky lighting.",
                material: "Set custom skybox material, see skybox.effect.",
            },
            fog: {
                enabled: "Enable or disable global fog effect.",
                accurate:
                    "Toggle vertex fog and pixel fog. <br>Pixel fog has more accurate visual effect with low vertex count objects, <br>but vertex fog has better performance.",
                fogColor: "Fog In-Scattering Color.",
                type: "Different calculation models.",
                fogDensity: "The larger the value, the more foggy it looks.",
                fogStart:
                    "Fog will start with this value (world space unit). <br>Increase this value if you want more clarity nearby.",
                ...
                fogRange:
                    "Fog extends down this range value (world space unit) from the top point.",
            },
            shadow: {
                ...
                planeDirection:
                    "The normal vector of the plane which receives shadow.",
                planeHeight:
                    "The height from the origin of the plane which receives shadow.",
                planeBias:
                    "Positional offset values in planar shading calculations.",
                shadowMapSize: "Shadowmap resolutions.",
                maxReceived:
                    "Number of the effective light sources that produce shadows.",
            },
            animation: {
                default_clip:
                    "When checking, the default animation clip is automatically played.",
                clips: "You can access and play animation clips via a script",
                play_on_load:
                    "Automatically play animation clip with the scene is loaded",
                use_baked_animation:
            ...
            camera: {
                ...
                clear_flags:
                    "Clearing flags of the camera, <br>specifies which part of the framebuffer will be actually cleared every frame",
                ...
                postprocess:
                    "If camera post process is not specified, will use the global post process.",
            },
            lights: {
                ...
                visibility:
                    "Visibility mask, declaring a set of node layers that will be visible to this valid punctual Light(Does not work with directional light)",
                ...
                angleAttenuationStrength:
                    "The angle attenuation strength of the light. The larger the value, the softer the edge, and the smaller the value, the harder the edge.",
                shadowEnabled: "Enable or disable real time shadows",
                shadowPcf: "Enable soft shadows",
                shadowBias:
                    "Bias value (world space unit) that can avoid moire artifacts with shadows. <br>The more the value, the more the light leakage",
                shadowNormalBias:
                    "Bias value (world space unit) that can avoid moire artifacts with surfaces that parallel to the directional light",
                shadowSaturation:
                    "Shadow saturation. This value should be 1.0.<br>We recommend that you'd rather increase ambient lighting than modify this value",
                shadowDistance:
                    "Shadows do not appear beyond this distance (world space unit)",
                shadowInvisibleOcclusionRange:
                    "If some shadow near the camera is missing, <br>increase this value (world space unit) to fix it",
                enableCSM: "Enable CSM",
                shadowFixedArea:
                    "Toggle CSM and fixed area shadows. <br>When checking, shadow will not follow camera, it distributes around directional light position. <br>It is a legacy mode that we do not recommend",
                shadowNear: "Fix area start",
                shadowFar: "Fix area end",
                shadowOrthoSize:
                    "Fix area size, the larger value, the lower precision of shadows",
                shadowAdvancedOptions: "shadow advanced options",
                csmLayersTransition:
                    "Enable or disable CSM layers transition(Improve quality, reduce performance)",
                csmTransitionRange:
                    "CSM layers transition range(in NDC space: value range is 0 to 1)",
            },
            sprite: {
                original_size:
                    "Use the Image's original size as the Node size?",
                edit_button: "Edit",
                select_button: "Select In Atlas",
                select_tooltip: "Choose Atlas",
                edit_tooltip: "Open Sprite Editor, set squares and other data",
                fill_type:
                    "The direction of filling, choose from Horizontal, Vertical and Radial",
                fill_center:
                    "For radial filling, set the center of the circle, value range is 0 to 1",
                fill_start:
                    "The normalized value indicates where to start filling",
                fill_range:
                    "The normalizad value indicates how much of the sprite we want to show",
                src_blend_factor: "The source image blend mode",
                dst_blend_factor: "The destination image blend mode",
            },
            UIOpacity: {
                opacity:
                    "The value between 0 to 255 showing the transparency of the object",
            },
            billboard: {
                ...
                rotation:
                    "Angle of rotation around the center point of Billboard",
            },
            button: {
                click_event: {
                    ...
                    customEventData:
                        "The extra event data passed to the event handler, <br>it's passed in as the last argument in the event handler. ",
                },
                interactable:
                    "Interactable state of the button, <br>when this item is unchecked, the button is disabled",
                ...
                duration:
                    "Transition time for button color change or zoom change",
                zoom_scale:
                ...
                auto_gray_effect:
                    "When this flag is true, <br>Button target sprite will turn gray when interactable is false.",
                normal_sprite:
                    "The sprite frame used when the button is in a normal sate.",
                pressed_sprite:
                    "The sprite frame used when the button is in a pressed sate.",
                hover_sprite:
                    "The sprite frame used when the button is in hovered over.",
                disabled_sprite:
                    "The sprite frame used when the button is in a disabled sate.",
                target: "reference to the Sprite as target's background. <br>When the state of the target changes the sprite's color or sprite frame will be updated.",
                click_events:
                    "By changing the number to 1 or more, <br>you can set the receiver and the handler for each click event",
            },
            canvas: {
                camera: "2D rendering camera",
                align: "Automatically calculate parameters for the camera.",
                design_resolution:
                    "The resolution of the assets used in the game, in pixels.",
                fit_height:
                    "Canvas allows designers to automatically scale the resolution to the full height of devices screen",
                fit_width:
                    "Canvas allows designers to automatically scale the resolution to the full width of devices screen",
            },
            forceOvertimeModule: {
            ...
            line: {
                ...
                wordSpace:
                    "Which coordinate the point in line belongs to. <br>Check if in world space, otherwise local space",
            ...
            progress: {
                bar_sprite:
                    "A progress bar is displayed with the Sprite node that can dynamically change the size",
                ...
                total_length:
                    "Length of progress bar. The maximum length of 100",
                progress: "Current progress indicator, ranging from 0-1",
                reverse:
                    "Can the progress bar update negatively (i.e go backwards)",
            },
            scrollbar: {
                ...
                auto_hide_time:
                    'How long will the scroll bar to be hidden after no scrolling action.<br>Note: Only valid if "enableAutoHide" is true',
            },
            scrollview: {
                ...
                elastic:
                    "If elastic is set, the content will bounce back when it's moved out of scroll boundary.",
                horizontal_bar: "Horizontal scrollbar",
                vertical_bar: "Vertical scrollbar",
                bounceDuration:
                    "The elapse time for bouncing. <br>A value of 0 means the content will bounce back immediately.",
                scrollEvents: "Scrollview events callback",
                cancelInnerEvents:
                    "If cancelInnerEvents is set to true, <br>the scroll behavior will cancel touch events on inner content nodes",
            },
            pageview: {
            ...
            particleSystemRenderer: {
                ...
                velocityScale:
                    "Lerp speed of particle along move direction when render mode is Stretched Billboard",
                lengthScale:
                    "Lerp length of particle along move direction when render mode is Stretched Billboard",
            ...
            rotationOvertimeModule: {
                separateAxes:
                    "Set rotation of X, Y and Z respectively (not supported now)",
            ...
            textureAnimationModule: {
                ...
                startFrame:
                    "Which frame start to play during the lifetime of particle system",
                cycleCount: "Playing cycle count of whole lifetime",
                randomRow:
                    "Generate animation by a row of texture random selected,<br>only valid in SingleRow",
                rowIndex:
                    "Generate animation by a row of texture at [rowIndex],<br>only valid in SingleRow and randomRow is disabled",
            },
            toggle: {
                interactable:
                    "Interactive Toggle? When this one is not selected, the Toggle is in a disabled state",
                ...
                duration:
                    "How long until the Toggle color/scale transitions to a new color?",
                zoom_scale:
                ...
                auto_gray_effect:
                    "When this flag is true, <br>the Toggle target sprite will turn gray when interactable is false.",
                normal_sprite:
                    "The Sprite that is used when the Toggle is in a normal sate.",
                pressed_sprite:
                    "The Sprite that is used when the Toggle is in a pressed sate.",
                hover_sprite:
                    "The Sprite that is used when the Toggle is hovered over.",
                disabled_sprite:
                    "The Sprite that is used when the Toggle is in a disabled sate.",
                target: "reference to the Sprite as Toggle's background. <br>When the state of the button changes the sprite's color or sprite frame will be updated.",
                isChecked:
                ...
                checkMark:
                    "The Sprite component displayed when Toggle is checked.",
                toggleGroup:
                ...
                check_events:
                    "The events triggered while toggle item is checked",
            },
            toggle_group: {
                allowSwitchOff:
            ...
            shapeModule: {
                ...
                alignToDirection:
                    "Particle move direction align to its origin direction",
                randomDirectionAmount:
                    "Random setting of particle move direction",
                sphericalDirectionAmount:
                    "Lerp value between current emit direction and current move direction",
                randomPositionAmount:
                    "Random setting of particle move position(particle will appear beyond emit range)",
                radius: "Radius of particle emitter",
                radiusThickness:
                    "Radius thickness of particle emitter (invalid when emitter type is Box):<br> - 0 emit from surface；<br> - 1 emit from center；<br> - 0 ~ 1 emit between center and surface",
                ...
                boxThickness:
                    "Thickness of particle emitter (only valid when emitter type is Box)",
            },
            slider: {
            ...
            velocityOvertimeModule: {
                ...
                speedModifier:
                    "Speed ​​correction factor (CPU particle supported only)",
                space: "Space where velocity calculated",
            },
            widget: {
                target: "Specifies an alignment target that can only be one of the parent nodes of the current node. <br>The default value is null, and when null, indicates the current parent",
                ...
                align_h_center:
                    "Align to the horizontal midpoint of the target Node",
                align_v_center:
                    "Align to the vertical midpoint of the target Node",
                align_mode:
                    "Specifies the alignment mode of the Widget, <br>which determines when the widget should refresh at runtime.",
                ...
                horizontal_center:
                    "Horizontal midpoint offset in pixels. <br>This can be a percentage and a positive or negative value",
                vertical_center:
                    "Vertical midpoint offset in pixels. <br>This can be a percentage and a positive or negative value",
            },
            layout: {
                layout_type:
                ...
                padding_bottom:
                    "Use a padding between bottom sides of the Node",
                space_x: "The horizontal distance between adjacent child Nodes",
                space_y: "The vertical distance between adjacent child Nodes",
                vertical_direction:
                    "Vertically align in the direction of the child Nodes: <br> 1. TOP_TO_BOTTOM, <br> 2. BOTTOM_TO_TOP",
                horizontal_direction:
                    "Horizontally align in the direction of the child Nodes: <br> 1. LEFT_TO_RIGHT <br> 2. RIGHT_TO_LEFT",
                cell_size: "In Grid layout, the size of each child element.",
                start_axis:
                    "In Grid layout, the arrangement direction of children elements.",
                constraint:
                    "In Grid layout, content layout constraints, including: <br> 1.NONE, no constraints <br> 2.FIXED_ROW, fixed number of rows <br> 3.FIXED_COL, fixed number of columns",
                constraint_number:
                    "In Grid layout, number of rows or columns for content layout constraints",
                affected_scale: "Child node scaling affects layout",
                align_horizontal:
                    "Align content horizontally<br>Fixed starting position in the same direction when Type is Horizontal.",
                align_vertical:
                    "Align content vertically<br>Fixed starting position in the same direction when Type is Vertical.",
            },
            particle: {
            ...
            editbox: {
                ...
                returnType:
                    "The keyboard return type of Edit Box. This is useful for keyboard of mobile device.",
                input_flag:
                    "Specify the input flag: password or capitalize word. ",
                ...
                stay_on_top:
                    "Set to true and the input is always visible and be on top of the game view",
                tab_index:
                ...
                editing_began:
                    "The event handler to be triggered when user begin to edit text",
                text_changed:
                    "The event handler to be triggered when the text content changes",
                editing_ended:
                    "The event handler to be triggered when user stop editing.<br>In single line mode, the function is usually called when the user presses enter or clicks outside the input box on the screen. <br> In case of multiline input, the function is usually called when the user clicks outside the input box on the screen",
                editing_return:
                    "The event handler to be called when return key is pressed.<br>In single line mode, pressing the Enter key also causes the input box to lose focus.",
            },
            videoplayer: {
                resourceType:
                    "The resource type of video player, <br>REMOTE for remote url and LOCAL for local file path.",
            ...
            webview: {
                ...
                webviewEvents:
                    "The Webview's event callback , <br>it will be triggered when certain Webview event occurs.",
            },
            UICoordinateTracker: {
                target: "Target node",
                ...
                sync_events:
                    "Event callback after coordinates synchronization.<br>The first parameter of the callback is the mapped local coordinate in UI camera.<br>The second parameter is the distance scale of the 3d node from the 3d camera viewport.",
            },
            subContextView: {
                design_size:
                    "Design resolution of the SubContextView, dynamic updates at runtime is not possible",
            ...
            particle_system: {
                ...
                texture:
                    "Texture of Particle System, readonly, please use Sprite Frame to setup new texture",
                particleCount:
                ...
                playOnLoad:
                    "If set to true, the particle system will automatically start playing on load",
                autoRemoveOnFinish:
                ...
                tangentialAccel:
                    "Tangential acceleration and variation of each particle. <br>Only available in Gravity mode ",
                radialAccel:
                    "Acceleration and variation of each particle. <br>Only available in Gravity mode",
                rotationIsDir:
                    "Indicate whether the rotation of each particle equals to its direction. <br>Only available in Gravity mode",
                startRadius:
                    "Starting radius and variation of the particles. <br>Only available in Radius mode",
                endRadius:
                    "Ending radius and variation of the particles. <br>Only available in Radius mode",
                rotatePerS:
                    "Number of degrees to rotate a particle around the source pos per second and variation. <br>Only available in Radius mode",
                capacity:
                    "Maximum particle amount that the system can generate",
                scaleSpace: "Scale space",
                startSize3D:
                    "Set start size of X, Y and Z respectively if true",
                ...
                startRotation3D:
                    "Set rotation of X, Y and Z respectively if true",
                ...
                startDelay:
                    "Time delayed of particle emit after the system start running",
                startLifetime: "Life time of the particle",
                duration: "Particle duration",
                loop: "Loop animation",
                prewarm:
                    "Animation plays from the end state of last round (only valid when loop activated)",
                simulationSpace:
                    "The particle space your calculation is done in",
                simulationSpeed: "Update ratio of particles",
                playOnAwake: "Play on awake",
                gravityModifier:
                    "How much particles get affected by the gravity (only support on CPU)",
                rateOverTime: "Number of particles emitted per second",
                rateOverDistance:
                    "Number of particles emitted per unit distance",
                ...
                limitVelocityOvertimeModule:
                    "Particle velocity limitation module (only support on CPU)",
                rotationOvertimeModule: "Particle rotation module",
                textureAnimationModule: "Texture animation module",
                trailModule:
                    "Trail module (only supported in CPU particle system)",
                noiseModule:
                    "Noise module (only supported in CPU particle system)",
                renderer: "Particle render module",
                renderCulling:
                    "Whether to enable the particle culling feature. <br>If enabled, a particle emitter bounding box will be generated, <br>and the particle emitter will be culled if the bounding box is not in the visible range of the camera. <br>Please refer to the cullingMode option below for the behavior settings after particle culling.",
                cullingMode:
            ...
            physics2d: {
                ...
                collider: {
                    ...
                    threshold:
                        "Specifies the minimum distance between the vertices of the generated map outline, the larger the value, the fewer points will be generated, adjustable according to requirements",
                    density: "The density",
                    ...
                    connectedBody:
                        "The rigid body to which the other end of the joint is attached.",
                    collideConnected:
                    ...
                    linearOffset:
                        "The linear offset from connected rigid body to rigid body.",
                    angularOffset:
                        "The angular offset from connected rigid body to rigid body.",
                    maxForce: "The maximum force can be applied to rigid body.",
                    maxTorque:
                        "The maximum torque can be applied to rigid body.",
                    correctionFactor:
                        "The position correction factor in the range [0,1].",
                    mouseRegion:
                        "The node used to register touch event. <br>If this is null, it will be the joint's node.",
                    ...
                    maxMotorForce:
                        "The maximum force can be applied to rigid body to reach the target motor speed.",
                    motorSpeed: "The expected motor speed.",
                    referenceAngle:
                        "The reference angle. <br>An angle between bodies considered to be zero for the joint angle.",
                    lowerAngle: "The lower angle.",
                    upperAngle: "The upper angle.",
                    maxMotorTorque:
                        "The maximum torque can be applied to rigid body to reach the target motor speed.",
                ...
                joint: {
                    ...
                    maxLength: "The max length.",
                    autoCalcDistance:
                        "Whether to automatically calculate the distance between two rigid bodies connected by a joint",
                    autoCalcAngle:
                        "Automatically calculates the sliding direction based on the two rigid bodies connected",
                    autoCalcOffset:
                        "Automatically calculate the angularOffset and linearOffset between two rigid bodies connected by a joint",
                },
            },
            block_input_events: {
                brief_help:
            ...
            features: {
                ...
                gfx_webgl2: {
                    label: "WebGL 2.0",
                    description:
                        "Include support for WebGL 2.0 graphics API.<br> If WebGL 2.0 is not available on target platform, the one will fallback as WebGL 1.0.",
                },
                gfx_webgpu: {
                    label: "WebGPU",
                ...
                base_3d: {
                    ...
                    description:
                        "Components and tools that are widely used in general 3D applications.",
                },
                particle: {
                ...
                primitives: {
                    ...
                    description:
                        "Libraries that used to create primitive geometries.",
                },
                base_2d: {
                    label: "Basic 2D Features",
                    description:
                        "Components and tools that are widely used in general 2D applications.",
                },
                sorting_2d: {
                    label: "2D Rendering Sorting",
                    description:
                        "Sorting UIRenderers by the configuration in Sorting2D component.",
                },
                rich_text: {
                    label: "Rich Text",
                ...
                physics_2d: {
                    ...
                    description:
                        "Physics system that applied to 2D application.",
                },
                physics_2d_builtin: {
                ...
                particle_2d: {
                    ...
                    description:
                        "Particle system that applied to 2D application.",
                },
                light_probe: {
                    label: "Light Probe",
                ...
                profiler: {
                    label: "Running Stats",
                    description:
                        "Include various components and tools used to audit and display rendering stats.",
                },
                occlusion_query: {
                ...
                geometry_renderer: {
                    ...
                    description:
                        "Used to render various geometries for debugging or use in editor.",
                },
                debug_renderer: {
                ...
                procedural_animation: {
                    ...
                    description:
                        "Enable the procedural animation related features, such as pose graph etc.",
                },
                xr: {
                    label: "XR",
                ...
                custom_pipeline: {
                    ...
                    description:
                        "The new render pipeline is based on data-oriented render graph. Users can write cross platform render pipelines and optimize for the specific platform.",
                },
                custom_pipeline_post_process: {
                    label: "Post Process Module (Deprecated)",
                    description:
                        "The render pipeline used in previous versions. This pipeline will be deprecated in future versions.",
                },
                legacy_pipeline: {
                ...
                websocket: {
                    label: "WebSocket",
                    description:
                        "Enable WebSocket for native. For implementation, iOS/macOS uses SocketRocket, Android uses OkHttp, and Windows uses libwebsockets.",
                },
                websocket_server: {
                    label: "WebSocket Server",
                    description:
                        "Enable WebSocket Server for native. Note: WebSocket must also be enabled.",
                },
                flags: {
                    spine: {
                        loadManual: {
            ...
            renderable_2d: {
                srcBlendFactor:
                    "Specifies the source blend mode, <br>it will clone a new material object.",
            ...
            physics3d: {
                rigidbody: {
                    ...
                    linearDamping:
                        "Used to decay the linear velocity, <br>the larger it is, the faster the decay will be",
                    angularDamping:
                        "Used to decay the angular velocity, <br>the larger it is, the faster the decay will be",
                    useGravity: "Whether to use gravity",
                    linearFactor:
                        "For scaling physical values (velocity or force) in each axis direction",
                    angularFactor:
                        "Angular factor to scale physical values (velocity or force) in each axis direction",
                },
                collider: {
                    attached:
                        "The rigid body where the collider is attached to",
                    sharedMaterial:
                        "The physical material used, default when not set",
                    isTrigger:
                        "Whether it is a trigger, the trigger does not generate physical feedback",
                    center: "The center of the shape in the local coordinate system",
                    sphere_radius:
                        "The radius of the sphere in the local coordinate system",
                    box_size:
                        "The size of the box in the local coordinate system",
                    capsule_radius:
                        "The radius of the sphere on the capsule body in the local coordinate system",
                    capsule_cylinderHeight:
                        "The height of the cylinder on the capsule in the local coordinate system",
                    capsule_direction:
                        "The orientation of the capsule body in the local coordinate system",
                    cone_radius:
                        "The radius of the upper circular surface of the cone in the local coordinate system",
                    cone_height:
                        "The height of the cone in the corresponding axial direction in the local coordinate system",
                    cone_direction:
                        "The orientation of the cone in the local coordinate system",
                    cylinder_radius:
                        "The radius of the circular surface on the cylinder in the local coordinate system",
                    cylinder_height:
                        "The height of the cylinder in the corresponding axial direction in the local coordinate system",
                    cylinder_direction:
                        "The orientation of the cylinder in the local coordinate system",
                    plane_normal:
                        "The normal to the plane in the local coordinate system",
                    plane_constant:
                        "The distance of the plane moving along the normal from the origin in the local coordinate system",
                    mesh_mesh: "Mesh resources used by collider",
                    mesh_convex:
                        "Whether to use convex hull approximation instead, <br>the number of vertices should be less than 255, <br>and the dynamics can be supported after turning on",
                    simplex_shapeType:
                        "Simplex type, point, line, triangle, tetrahedron",
                ...
                constant_force: {
                    ...
                    localForce:
                        "The force apply on a rigid body in the local coordinate system",
                    torque: "The torque applied to the rigid body in the world coordinate system",
                    localTorque:
                        "The torque applied to the rigid body in the local coordinate system",
                },
                constraint: {
                    attachedBody:
                        "The rigid body where the constraint is attached to",
                    connectedBody:
                        "The rigid body connected to the constraint, <br>if not set, the world object will be used",
                    enableCollision:
                    ...
                    secondaryAxis:
                        "The secondary axis of the constraint in the local coordinate system of the attached rigid body",
                    autoCalculatePivotB:
                        "Automatically derivate the pivotB from the pivotA and the relative transform of the two rigid bodies",
                    linearLimit: {
                        ...
                        enableSoftConstraint:
                            "Whether to enable soft constraint",
                    ...
                    angularLimit: {
                        ...
                        swingMotion1:
                            "The constraint mode of the swing y angle",
                        swingMotion2:
                            "The constraint mode of the swing z angle",
                        ...
                        enableSoftConstraintSwing:
                            "Whether to enable soft constraint for the swing constraint",
                        swingStiffness:
                            "The stiffness factor of the swing constraint",
                        swingDamping:
                            "The damping factor of the swing constraint",
                        swingRestitution:
                            "The restitution factor of the swing constraint",
                        enableSoftConstraintTwist:
                            "Whether to enable soft constraint for the twist constraint",
                        twistStiffness:
                            "The stiffness factor of the twist constraint",
                        twistDamping:
                            "The damping factor of the twist constraint",
                        twistRestitution:
                            "The restitution factor of the twist constraint",
                    },
                    linearDriver: {
                    ...
                    angularDriver: {
                        ...
                        targetOrientation:
                            "The target orientation of the driver",
                        targetAngularVelocity:
                            "The target angular velocity of the driver",
                        strength: "The strength of the driver",
                    },
                },
                character_controller: {
                    ...
                    minMoveDistance:
                        "The minimum movement distance of the character controller.",
                    stepOffset: "The step offset of the character controller.",
                    slopeLimit:
                        "The slope limit of the character controller in degree.",
                    skinWidth: "The skin width of the character controller.",
                    detectCollisions:
                        "If the character controller can collide with other objects without calling move().",
                    enableOverlapRecovery:
                        "If the character controller enable overlap recovery when penetrating with other colliders.",
                    center: "The center of the character controller in local space.",
                    capsuleRadius:
                        "The radius of the sphere of the capsule shape of the character controller in local space.",
                    capsuleHeight:
                        "The height of the capsule shape of the character controller in local space.",
                    boxHalfHeight:
                        "The half height of the box shape of the character controller in local space.",
                    boxHalfSideExtent:
                        "The half side extent of box shape of the character controller in local space.",
                    boxHalfForwardExtent:
                        "The half forward extent of the box shape of the character controller in local space.",
                },
            },
            octree_culling: {
                enabled:
                    "The switch of octree culling, only available for native platforms.",
            ...
            skin: {
                ...
                blurRadius:
                    "This parameter specifies the range of subsurface scattering , in other words, scattering filter width.",
                sssIntensity:
                    "This parameter specifies the intensity of subsurface scattering.",
            },
            light_probe: {
                ...
                showWireframe:
                    "The switch of showing connection of light probe.",
                showConvex: "The switch of showing convex of light probe.",
                lightProbeSphereVolume:
                    "The value of all light probe sphere display size",
            },
            light_probe_group: {
            ...
            reflection_probe: {
                fastBake:
                    "If checked, generating progress will ignore GGX convolution for cubemap, very fast generation.",
            },
            hbao: {
                radiusScale:
                    "The range of ambient occlusion, by adjusting this value, the dark area can be better adapted to the scale of the scene.",
                aoSaturation:
                    "The saturation of ambient occlusion, the higher the value, the darker.",
                needBlur:
                    "Turn on for a softer effect with less noise, but it consumes some performance.",
            },
            bloom: {
                enableAlphaMask:
                    "Transparent channel flag bit, if you turn on this function, please also reduce the object material intrinsic color a channel output, a value of less than 1 object will not have a flood light",
                useHdrIlluminance:
                    "To use scene HDR brightness to filter flooded areas, both HDR mode and the CC_USE_FLOAT_OUTPUT macro must be enabled.",
                threshold:
                    "The brightness threshold, brighter area will produce bloom, this value unit is the LDR brightness seen by the human eye, independent of exposure.",
                iterations:
                    "The number of blur iterations, the higher the value that results in a larger and softer flare range, but with reduced performance.",
                intensity:
                    "Flood intensity, the higher the value, the brighter the halo, please adjust it moderately.",
            },
            color_grading: {
                contribute:
                    "Adjust contribution of LUT for screen color, The influence on screen color can be adjusted in the range of 0-1.",
                originalMap:
                    "Support arbitary LUT for Nx1 blocks or 8x8 blocks automatically. The builtin lut texture path is internal/dependencies/textures/lut/.",
            },
            taa: {
                sampleScale:
                    "TAA sample range. Smaller values are recommended, as too large values may cause jittering.",
                feedback:
                    "History frame blend value. The higher the value, the better the anti-aliasing effect, but the picture may become blurry.",
            },
            fsr: {
                sharpness: "Sharpness",
            },
            ...
            tone_mapping: {
                toneMappingType:
                    "Tone mapping type,valid only when HDR is enabled.",
            },
        },
